...
echo "Will create a new *$PRIVACYWORD* repo named rsyslogd-server"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo Rsyslog server running inside docker container.
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d \
    "{\"name\": \"rsyslogd-server\", \"description\": \"Rsyslog server running inside docker container.\", \"private\": $PRIVATE_TF}"
