...
`rsyslogd-server` could always use more documentation, whether as part of the
...
Ready to contribute? Here's how to set up `rsyslogd-server` for local development.

 1. Fork the `rsyslogd-server` repo on GitHub.
